...
export default function WorshipScreen() {
  ...
  return (
    <div className="relative min-h-dvh">
      {/* Header */}
      <header className="relative overflow-hidden rounded-b-[2.5rem] bg-gradient-to-b from-emerald-50 to-teal-50/50 pb-8 pt-12 shadow-sm">
        ...
        <div className="relative px-6 z-10">
          <div className="flex justify-between items-start mb-6">
            ...
            <Link href="/profil" className="p-2 bg-white/60 rounded-full backdrop-blur-sm shadow-sm">
              <span className="material-icons-round text-primary-dark text-2xl">notifications</span>
            </Link>
          </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center justify-between relative overflow-hidden">
              ...
              <div className="z-10">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-medium text-gray-500 uppercase tracking-wide">Sonraki Namaz</span>
                </div>
        ...
        <section className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <select
              ...
              className="flex-1 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/30"
            >
              {surahs.map((s) => (
          ...
          {surahData && (
            <div className="mt-4 max-h-[50dvh] space-y-3 overflow-auto pr-1 no-scrollbar">
              {mergedAyahs.map((a) => (
                <div key={a.key} className="rounded-xl border border-gray-100 p-4 hover:bg-gray-50 transition-colors">
