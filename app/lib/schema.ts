...
export const mockExamResults = pgTable("mock_exam_results", {
  ...
  examType: varchar("exam_type", { length: 50 }).notNull().default("Deneme"),
  examDate: timestamp("exam_date").notNull(),
  turkishCorrect: integer("turkish_correct").notNull().default(0),
  turkishWrong: integer("turkish_wrong").notNull().default(0),
  mathCorrect: integer("math_correct").notNull().default(0),
  mathWrong: integer("math_wrong").notNull().default(0),
  socialCorrect: integer("social_correct").notNull().default(0),
  socialWrong: integer("social_wrong").notNull().default(0),
  scienceCorrect: integer("science_correct").notNull().default(0),
  scienceWrong: integer("science_wrong").notNull().default(0),
  totalNet: decimal("total_net", { precision: 5, scale: 2 }).notNull().default("0"),
